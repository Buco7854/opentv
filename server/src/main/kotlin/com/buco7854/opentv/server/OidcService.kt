...
class OidcService(
    ...
    /** Where a flow lands when the caller has no better idea; see [PublicOrigin]. */
    private val configuredCallback: URI get() = config.publicUrl.resolve(OIDC_CALLBACK_PATH)
    ...
    internal suspend fun callback(
        ...
        val grant = AuthorizationCodeGrant(
            ...
            payload.redirectUri.takeIf(String::isNotBlank)
