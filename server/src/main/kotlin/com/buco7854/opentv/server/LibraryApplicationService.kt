...
class LibraryApplicationService(
    ...
    suspend fun channelByContent(actor: Actor, contentId: String): ChannelDto {
        val channel = channelByContentModel(actor, contentId)
        return channel.toDto(cipher, contentId, actor.userId)
    }
